...
class ControleurUser extends Controleur
{
     ...
     /**
      * Contréle de l'URL pour exécuter l'action qui en découle
      *
      */
     ...
     private function connecter($userInstance, $msg = false)
     {
          if (isset($_POST['Envoyer'])) {
               if ($userInstance->DBgetConnexion($_POST['email'], $_POST['password'])) {
                    //new ControleurAccueil(); // retour é la page d'accueil commenté pour prevnir le revoi du formulaire par un rafrechissment de la page une fois connecté 
